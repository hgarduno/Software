    ...
    : QWidget( parent, name, fl )
{
    ...
    ComprasImportacionesLayout->addMultiCellLayout( layout27, 4, 4, 0, 2 );
    ...
    ComprasImportacionesLayout->addMultiCellLayout( layout8, 3, 3, 0, 2 );
    ...
    layout30->addLayout( layout27_2_2 );

    groupBox2Layout->addLayout( layout30, 0, 0 );

    ComprasImportacionesLayout->addWidget( groupBox2, 2, 0 );
    ...
    ComprasImportacionesLayout->addWidget( groupBox1, 2, 1 );
    ...
    ComprasImportacionesLayout->addWidget( groupBox3, 2, 2 );
    ...
    ComprasImportacionesLayout->addMultiCellLayout( layout56, 0, 5, 3, 3 );
    ...
    ComprasImportacionesLayout->addMultiCellLayout( layout32_3, 5, 5, 0, 2 );
    ...
    ComprasImportacionesLayout->addMultiCellLayout( layout61, 0, 0, 0, 2 );
    ...
    layout33->addLayout( layout5 );

    layout32_4 = new QVBoxLayout( 0, 0, 6, "layout32_4"); 

    textLabel1_12 = new QLabel( this, "textLabel1_12" );
    layout32_4->addWidget( textLabel1_12 );

    ctrlClavesProveedores1 = new QCtrlClavesProveedores( this, "ctrlClavesProveedores1" );
    ctrlClavesProveedores1->setEnabled( FALSE );
    ctrlClavesProveedores1->setSizePolicy( QSizePolicy( (QSizePolicy::SizeType)7, (QSizePolicy::SizeType)5, 0, 0, ctrlClavesProveedores1->sizePolicy().hasHeightForWidth() ) );
    layout32_4->addWidget( ctrlClavesProveedores1 );
    layout33->addLayout( layout32_4 );
    ...
    layout30_2->addLayout( layout1_3 );
    ...
    layout30_2->addLayout( layout1_3_2 );
    ...
    layout30_2->addLayout( layout1_3_2_2 );
    ...
    layout30_2->addLayout( layout1_3_3 );
    layout34->addLayout( layout30_2 );

    ComprasImportacionesLayout->addMultiCellLayout( layout34, 1, 1, 0, 2 );
    languageChange();
    resize( QSize(1203, 617).expandedTo(minimumSizeHint()) );
...
"Partidas" ) );
    ...
    textLabel1_12->setText( tr( "Claves Proveedores" ) );
