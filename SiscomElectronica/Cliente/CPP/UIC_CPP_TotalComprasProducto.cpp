/****************************************************************************
** Form implementation generated from reading ui file 'UI/TotalComprasProducto.ui'
**
...
/*
 *  Constructs a TotalComprasProducto as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 */
TotalComprasProducto::TotalComprasProducto( QWidget* parent, const char* name, WFlags fl )
    : QWidget( parent, name, fl )
{
    if ( !name )
	setName( "TotalComprasProducto" );
    TotalComprasProductoLayout = new QGridLayout( this, 1, 1, 0, 0, "TotalComprasProductoLayout"); 
    ...
    TotalComprasProductoLayout->addLayout( layout32, 0, 0 );
    languageChange();
    resize( QSize(478, 100).expandedTo(minimumSizeHint()) );
 ...
 */
TotalComprasProducto::~TotalComprasProducto()
{
