#ifndef __QCTRLCLAVESPROVEEDORES_H__
#define __QCTRLCLAVESPROVEEDORES_H__
#include <qwidget.h>
...
class zProductos;
class QT_WIDGET_PLUGIN_EXPORT QCtrlClavesProveedores:public QWidget 
{
Q_OBJECT
public:
	QCtrlClavesProveedores(QWidget *pQWParent=0,const char *pchrPtrName=0);
...
signals:
	...
	void SignalSelecciono(zClaveProveedor *);
