/****************************************************************************
** QCtrlRFCs meta object code from reading C++ file 'QCtrlRFCs.h'
**
...
const char *QCtrlRFCs::className() const
{
    return "QCtrlRFCs";
}

QMetaObject *QCtrlRFCs::metaObj = 0;
static QMetaObjectCleanUp cleanUp_QCtrlRFCs( "QCtrlRFCs", &QCtrlRFCs::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString QCtrlRFCs::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "QCtrlRFCs", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString QCtrlRFCs::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "QCtrlRFCs", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* QCtrlRFCs::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
	...
	0, 0 );
    cleanUp_QCtrlRFCs.setMetaObject( metaObj );
    return metaObj;
}

void* QCtrlRFCs::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "QCtrlRFCs" ) )
	return this;
...
void QCtrlRFCs::SignalSeleccionando( zSiscomRegistro* t0 )
{
    if ( signalsBlocked() )
	return;
...
void QCtrlRFCs::SignalSelecciono( zSiscomRegistro* t0 )
{
    if ( signalsBlocked() )
	return;
...
bool QCtrlRFCs::qt_invoke( int _id, QUObject* _o )
{
...
bool QCtrlRFCs::qt_emit( int _id, QUObject* _o )
{
...
bool QCtrlRFCs::qt_property( int id, int f, QVariant* v)
{
    return QWidget::qt_property( id, f, v);
}

bool QCtrlRFCs::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
