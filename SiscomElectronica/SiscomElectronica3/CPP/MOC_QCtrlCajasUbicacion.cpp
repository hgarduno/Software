/****************************************************************************
** QCtrlCajasUbicacion meta object code from reading C++ file 'QCtrlCajasUbicacion.h'
**
...
#undef QT_NO_COMPAT
#include "../H/QCtrlCajasUbicacion.h"
...
const char *QCtrlCajasUbicacion::className() const
{
    return "QCtrlCajasUbicacion";
}

QMetaObject *QCtrlCajasUbicacion::metaObj = 0;
static QMetaObjectCleanUp cleanUp_QCtrlCajasUbicacion( "QCtrlCajasUbicacion", &QCtrlCajasUbicacion::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString QCtrlCajasUbicacion::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "QCtrlCajasUbicacion", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString QCtrlCajasUbicacion::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "QCtrlCajasUbicacion", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* QCtrlCajasUbicacion::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
	...
	"QCtrlCajasUbicacion", parentObject,
	slot_tbl, 5,
	signal_tbl, 2,
	...
	0, 0 );
    cleanUp_QCtrlCajasUbicacion.setMetaObject( metaObj );
    return metaObj;
}

void* QCtrlCajasUbicacion::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "QCtrlCajasUbicacion" ) )
	return this;
...
void QCtrlCajasUbicacion::SignalSeleccionando( zSiscomRegistro* t0 )
{
    if ( signalsBlocked() )
	return;
...
void QCtrlCajasUbicacion::SignalSelecciono( zSiscomRegistro* t0 )
{
    if ( signalsBlocked() )
	return;
...
bool QCtrlCajasUbicacion::qt_invoke( int _id, QUObject* _o )
{
...
bool QCtrlCajasUbicacion::qt_emit( int _id, QUObject* _o )
{
...
bool QCtrlCajasUbicacion::qt_property( int id, int f, QVariant* v)
{
    return QWidget::qt_property( id, f, v);
}

bool QCtrlCajasUbicacion::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
