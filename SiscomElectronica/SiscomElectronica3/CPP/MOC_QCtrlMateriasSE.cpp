/****************************************************************************
** QCtrlMateriasSE meta object code from reading C++ file 'QCtrlMateriasSE.h'
**
...
const char *QCtrlMateriasSE::className() const
{
    return "QCtrlMateriasSE";
}

QMetaObject *QCtrlMateriasSE::metaObj = 0;
static QMetaObjectCleanUp cleanUp_QCtrlMateriasSE( "QCtrlMateriasSE", &QCtrlMateriasSE::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString QCtrlMateriasSE::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "QCtrlMateriasSE", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString QCtrlMateriasSE::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "QCtrlMateriasSE", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* QCtrlMateriasSE::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
	...
	0, 0 );
    cleanUp_QCtrlMateriasSE.setMetaObject( metaObj );
    return metaObj;
}

void* QCtrlMateriasSE::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "QCtrlMateriasSE" ) )
	return this;
...
void QCtrlMateriasSE::SignalSeleccionando( zSiscomRegistro* t0 )
{
    if ( signalsBlocked() )
	return;
...
void QCtrlMateriasSE::SignalSelecciono( zSiscomRegistro* t0 )
{
    if ( signalsBlocked() )
	return;
...
bool QCtrlMateriasSE::qt_invoke( int _id, QUObject* _o )
{
...
bool QCtrlMateriasSE::qt_emit( int _id, QUObject* _o )
{
...
bool QCtrlMateriasSE::qt_property( int id, int f, QVariant* v)
{
    return QWidget::qt_property( id, f, v);
}

bool QCtrlMateriasSE::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
