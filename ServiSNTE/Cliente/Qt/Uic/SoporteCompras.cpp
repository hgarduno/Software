/****************************************************************************
** Form implementation generated from reading ui file 'Qt/Ui/SoporteCompras.ui'
**
** Created: Sat Jan 27 16:38:30 2024
**
...
/*
 *  Constructs a SoporteCompras as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 */
SoporteCompras::SoporteCompras( QWidget* parent, const char* name, WFlags fl )
    : QWidget( parent, name, fl )
{
    if ( !name )
	setName( "SoporteCompras" );
    SoporteComprasLayout = new QGridLayout( this, 1, 1, 11, 6, "SoporteComprasLayout"); 
    ...
    SoporteComprasLayout->addLayout( layout6, 0, 0 );
    languageChange();
 ...
 *  language.
 */
void SoporteCompras::languageChange()
{
    setCaption( tr( "Soporte Compras" ) );
