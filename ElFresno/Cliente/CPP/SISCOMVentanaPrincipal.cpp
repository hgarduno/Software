...
{
//delete CSisDatCom;
CfrmFirmaUsuario2 *lCFRMFUsuario2=new CfrmFirmaUsuario2("ElFresno");
...
void SISCOMVentanaPrincipal::CreaMenus()
{
	...
	menuBar()->insertItem("Administracion El Fresno",QPMAplicacion);
	menuBar()->insertItem("Operacion El Fresno",QPMEstadisticas);
