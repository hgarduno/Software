...
int SiscomOpcionAInt(const char *pchrPtrOpcion, const StcSiscomOpciones *pStcSiscomOpciones);
float SiscomOpcionAFloat(const char *pchrPtrOpcion, const StcSiscomOpciones *pStcSiscomOpciones);


int SiscomEstaLaOpcion(const char *pchrPtrOpcion,const StcSiscomOpciones *pStcSiscomOpciones);
