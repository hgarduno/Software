...
void SiscomAsignaMemoriaNormalizacion(const char *pchrPtrEntrada,
...
void SiscomCambiaCaracteres2(unsigned char *pchrPtrCambia,
...
void SiscomCambiaCaracteres(unsigned char *pchrPtrCambia,
		      unsigned char *pchrPtrCadena)
{
...
void SiscomCambiaNulo(unsigned char *pchrPtrCadena)
{
int lintTamano=strlen(pchrPtrCadena);
...
{
		SiscomAsignaMemoriaNormalizacion(pchrPtrCadena,
					   pchrPtrSalida);
	strcpy(*pchrPtrSalida,pchrPtrCadena);
	SiscomQuitaMasDeUnEspacio(*pchrPtrSalida);
	SiscomCambiaCaracteres(pchrPtrCambia,*pchrPtrSalida);
	SiscomCambiaMayusculas(*pchrPtrSalida);
	SiscomCambiaNulo(*pchrPtrSalida);
	/* Martes 12 Julio 2022 
	 * Segun yo, esta funcion SiscomNormaliza , la uso de la 
	 * biblioteca libSiscomDesarrollo2 , 
	 * SiscomEliminaEspaciosInicio4(*pchrPtrSalida);
	 *
	 */
		     ...
		     unsigned char **pchrPtrSalida)
{
	...
	*/
	SiscomQuitaMasDeUnEspacio(*pchrPtrSalida);
	SiscomCambiaCaracteres2(pchrPtrCambia,*pchrPtrSalida);
	SiscomCambiaMayusculas(*pchrPtrSalida);
	/* Martes 12 Julio 2022 
	 *
	 *
