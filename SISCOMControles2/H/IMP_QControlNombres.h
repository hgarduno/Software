...
class CQPersona;
/*!
 * \file H/IMP_QControlNombres.h
 * Archivo Cabecear, que contiene la clase CQControlNombres, que es parte del proyecto
 * global SISCOMControles2
 */
/*!
 * Control Qt 3 que permite el manejo de los datos del nombre de una persona <br>
 */
