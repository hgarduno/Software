...
QMetaObject* QDevoluciones::staticMetaObject()
{
    ...
    static const QUMethod slot_0 = {"SlotConsultaOrden", 0, 0 };
    static const QUParameter param_slot_1[] = {
	{ 0, &static_QUType_int, 0, QUParameter::In },
	{ 0, &static_QUType_int, 0, QUParameter::In }
    };
    static const QUMethod slot_1 = {"SlotCambiaProducto", 2, param_slot_1 };
    static const QUMethod slot_2 = {"SlotDevuelve", 0, 0 };
    static const QUMethod slot_3 = {"SlotAnexar", 0, 0 };
    static const QUMethod slot_4 = {"SlotEliminar", 0, 0 };
    static const QMetaData slot_tbl[] = {
	{ "SlotConsultaOrden()", &slot_0, QMetaData::Private },
	{ "SlotCambiaProducto(int,int)", &slot_1, QMetaData::Private },
	{ "SlotDevuelve()", &slot_2, QMetaData::Private },
	{ "SlotAnexar()", &slot_3, QMetaData::Private },
	{ "SlotEliminar()", &slot_4, QMetaData::Private }
    };
...
bool QDevoluciones::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 0: SlotConsultaOrden(); break;
    case 1: SlotCambiaProducto((int)static_QUType_int.get(_o+1),(int)static_QUType_int.get(_o+2)); break;
    case 2: SlotDevuelve(); break;
    case 3: SlotAnexar(); break;
    case 4: SlotEliminar(); break;
    default:
